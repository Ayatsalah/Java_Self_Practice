...
public class CarShop {
    public static void main(String[] args) {
        ...
        for (Car each : cars) {
            if (each instanceof Honda) {
                if (each.year >= 2010 && each.year <= 2011) {
                    System.out.println(each.model + " " + each.color + " " + each.year + " eligible for recall ");
                }
            } else if (each instanceof Audi) {
                if (each.year >= 2015 && each.year <= 2019) {
                    System.out.println(each.model + " " + each.color + " " + each.year + " eligible for recall ");
                }
            } else {
        ...
        System.out.println("The car with the highest price is " + highestPrice);
        ...
        System.out.println("The car with the lowest price is " + lowestPrice);
